...
$db = @mysqli_connect("127.0.0.1", "test", "1432", "catalog") or die('Error!' . mysqli_connect_error());

$id = $_GET["id"];

$result = mysqli_query($db, "SELECT * FROM `catalogitems` WHERE itemdId = $id");
...
<body>
                ...
                <div class="header">
                    <nav class="header_content_l">
                        <ul class="header_left">
                            <li class="left"><a href="index.html"><img src="Pictures/heater_intro.svg" alt="intro"></a>
                            </li>
                            <li>
                    ...
                    <nav class="header_content_r">
                        <ul class="header_right">
                                    ...
                                    <div class="main_menu">
                                        ...
                                        <div class="icon_box">
                                            <div class="icon_boxes">
                                                <a class='icon_links' href="registartion.html"><img src="Pictures/man.svg" alt="">
                                                    <p class="ad_box">Regictration</p>
                                                </a>
                                            </div>
                                            <div class="icon_boxes">
                                                <a class='icon_links' href="cart.html"><img src="Pictures/basket.svg" alt="">
                            ...
                            <li class="right product_icon"><a href="registartion.html"><img src="Pictures/man.svg" alt=""></a></li>
                            <li class="carts"><a href="cart.html"><img src="Pictures/basket.svg" alt=""></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
    ...
    <div class="what-we-do">
        <div class="container">
            <div class="shop">
                <div class="card_div">
                    <a href="product.html" class="figure">
